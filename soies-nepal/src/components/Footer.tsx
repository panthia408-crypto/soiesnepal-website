          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-6">
              <a
                ...
                className="w-10 h-10 rounded-full bg-slate-200 dark:bg-navy-800 flex items-center justify-center text-slate-600 dark:text-navy-300 hover:bg-[#0077B5] hover:text-white"
                aria-label="LinkedIn"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-slate-200 dark:bg-navy-800 flex items-center justify-center text-slate-600 dark:text-navy-300 hover:bg-gradient-to-br hover:from-[#833AB4] hover:via-[#E1306C] hover:to-[#F77737] hover:text-white"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-slate-200 dark:bg-navy-800 flex items-center justify-center text-slate-600 dark:text-navy-300 hover:bg-[#FF0000] hover:text-white"
                aria-label="YouTube"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-slate-200 dark:bg-navy-800 flex items-center justify-center text-slate-600 dark:text-navy-300 hover:bg-[#5865F2] hover:text-white"
                aria-label="Discord"
              >
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="text-slate-500 dark:text-navy-300 hover:text-gold-500 dark:hover:text-gold-400 text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
